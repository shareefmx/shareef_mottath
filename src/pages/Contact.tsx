...
const Contact = () => {
  ...
  const handleSend = (e) => {
    ...
    const subject = "website feed";
    const body = `Name: ${name}%0D%0AEmail: ${email}%0D%0AMessage: ${message}`;
    window.location.href = `mailto:shareefmottath@outlook.com?subject=${encodeURIComponent(subject)}&body=${body}`;
  };
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="pt-24 sm:pt-32 pb-16 sm:pb-20 px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-light tracking-tighter mb-4 text-center">
            Get In Touch
          </h1>
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            <GlassCard className="bg-primary/10 border border-primary/30 shadow-[0_10px_40px_hsl(var(--primary)/0.15)] hover:bg-primary/20 hover:border-primary/50 transition-colors">
              <GlassCardContent className="p-6 sm:p-8">
                <form className="space-y-6  sm:text-left" onSubmit={handleSend}>
                  <div>
                    <label className="text-sm font-light mb-2 block">Name</label>
                    <Input
                      placeholder="Your name"
                      className="bg-background/50 text-base text-left"
                      value={formData.name}
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      className="bg-background/50 min-h-[150px] text-base text-left"
                  ...
                  <NeuroButton
                    variant="glow"
                    className="w-full bg-primary/90 hover:bg-primary shadow-[0_4px_14px_0_hsl(var(--primary)/0.5),inset_0_-2px_0_0_rgba(0,0,0,0.2)] hover:shadow-[0_6px_30px_0_hsl(var(--primary)/0.8),0_0_40px_hsl(var(--primary)/0.5),inset_0_-2px_0_0_rgba(0,0,0,0.2)]"
                    onClick={handleSend}
                  >
                    Send Message
                  </NeuroButton>
            ...
            <div className="space-y-6">
              <GlassCard className="bg-primary/10 border border-primary/30 shadow-[0_10px_40px_hsl(var(--primary)/0.15)] hover:bg-primary/20 hover:border-primary/50 transition-colors">
                <GlassCardContent className="p-6 flex flex-col sm:flex-row items-center sm:items-start gap-4 text-center sm:text-left">
